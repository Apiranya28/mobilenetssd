...
lineaccesstoken = '3SJnDaIJ91PLm+9NQFA/B0IlEtZTed0hJxZdsq2+3KN/1BG9Iyii/MROTqwCKOGa2VUZ39rGsW9RsNQPvUfetd3Ya86KzvCQ1ADQWe9Pc+Iwa+1/kbTinCvtyDho74x5fkMmOk3I5XBBI87cdGShYAdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
           replyObj = TextSendMessage(text="สวัสดีครัฟวัยรุ่น")
        elif msg == "ไปกินข้าวกันไหม":      
        ...
        elif msg == "ขอเงินหน่อย":  
            replyObj = TextSendMessage(text="ไม่มีตังค์ เสียใจด้วยಥ‿ಥ")
        else:  
            headers = request.headers 
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'}) 
            url = "hthttpsththttpstpsps://dialogflow.cloud.google.com/v1/integrations/line/webhook/1e84e106-24b1-48ae-912c-hthttpsththttpstpsps://dialogflow.cloud.google.com/v1/integrations/line/webhook/1e84e106-24b1-48ae-912c-2aeb69589d66" 
            requests.post(url,data=json_line, headers=json_headers)2aeb69589d66" 
